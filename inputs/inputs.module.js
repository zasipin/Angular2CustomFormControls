...
var range_input_component_1 = require('./range-input.component');
var InputsModule = (function () {
    ...
    InputsModule = __decorate([
        core_1.NgModule({
            ...
            exports: [range_input_component_1.RangeInputComponent],
            declarations: [range_input_component_1.RangeInputComponent],
            providers: []
        }), 
